...
public class PromoController {
	...
	public String create(Model model, @ModelAttribute Promo entityPromo, @ModelAttribute Student entityStudent) {
	...
	@PostMapping
	public String create(@Valid @ModelAttribute Promo entity, BindingResult result, RedirectAttributes redirectAttributes) {
		Promo promo = null;
		try {
